...
public struct Quadrilateral: Transformable {
    ...
    /// Initializing CIRectangleFeature
    ///
    /// - Parameter rectangleFeature: rectangleFeature gives all the corners of the rectangle
    ...
    /// Initializing the Points of all the corners in a rectangle
    ///
    /// - Parameters:
    ///   - topLeft: this point indiacates the topLeft corner of a rectangle
    ///   - topRight: this point indiacates the topRight corner of a rectangle
    ///   - bottomRight: this point indiacates the bottomRight corner of a rectangle
    ///   - bottomLeft: this point indiacates the bottomLeft corner of a rectangle
